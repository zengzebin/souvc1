...
public class CommonUtil {
	...
	public final static String token_url = "https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&"
			+ "appid=wx0a0703a588c2d202&secret=0c0635b36bf3d103406d566eb5bef9d1";
	...
	public static void main(String args[]) {
		String accessToken = CommonUtil.getToken("wx1220bd5d26516ec1", "46cd020be3ad67d853e8dd2301cf2a1c")
				.getAccessToken();
		/**
		 * 获取用户信息
		 */
		WeixinUserInfo user = getUserInfo(accessToken, "o8FfIw9cXn9XR5dnltJVXXlZUM1M");
